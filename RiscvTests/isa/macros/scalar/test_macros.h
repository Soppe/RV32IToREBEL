...
// #define MASK_XLEN(x) ((x) & ((1 << (__riscv_xlen - 1) << 1) - 1)) // The original one, but caused problems for projects who don't support arithmetic within an operator
...
//#define SEXT_IMM(x) ((x) | (-(((x) >> 11) & 1) << 11)) // The original one, but not used as the test values are instead manually updated to be the full length
#define SEXT_IMM(x) x
...
#define TEST_IMM_DEST_BYPASS( testnum, nop_cycles, inst, result, val1, imm ) \
    TEST_CASE( testnum, x6, result, \
      li  x4, 0; \
func1_ ## testnum:    li  x1, MASK_XLEN(val1); \
      inst x14, x1, SEXT_IMM(imm); \
      TEST_INSERT_NOPS_ ## nop_cycles \
      addi  x6, x14, 0; \
      addi  x4, x4, 1; \
      li  x5, 2; \
      bne x4, x5, func1_ ## testnum; \
    )
...
#define TEST_RR_SRC21_BYPASS( testnum, src1_nops, src2_nops, inst, result, val1, val2 ) \
    TEST_CASE( testnum, x14, result, \
      li  x4, 0; \
func1_ ## testnum:    li  x2, MASK_XLEN(val2); \
      TEST_INSERT_NOPS_ ## src1_nops \
      li  x1, MASK_XLEN(val1); \
      TEST_INSERT_NOPS_ ## src2_nops \
      inst x14, x1, x2; \
...
#define TEST_ST_OP( testnum, load_inst, store_inst, result, offset, base ) \
    TEST_CASE( testnum, x14, result, \
      la  x1, base; \
      li  x2, result; \
      la  x15, func7_ ## testnum; /* Tell the exception handler how to skip this test. */ \
...
test_ ## testnum: \
    ...
    li  x1, val1; \
    li  x2, val2; \
    inst x1, x2, func2_ ## testnum; \
    bne x0, TESTNUM, fail; \
func1_ ## testnum:  bne x0, TESTNUM, func3_ ## testnum; \
func2_ ## testnum:  inst x1, x2, func1_ ## testnum; \
    bne x0, TESTNUM, fail; \
func3_ ## testnum:
...
test_ ## testnum: \
    ...
    li  x1, val1; \
    li  x2, val2; \
    inst x1, x2, func1_ ## testnum; \
    bne x0, TESTNUM, func2_ ## testnum; \
func1_ ## testnum:  bne x0, TESTNUM, fail; \
func2_ ## testnum:  inst x1, x2, func1_ ## testnum; \
func3_ ## testnum:
...
test_ ## testnum: \
    li  TESTNUM, testnum; \
    li  x4, 0; \
func1_ ## testnum:  la  x6, func2_ ## testnum; \
    TEST_INSERT_NOPS_ ## nop_cycles \
    inst x6; \
    bne x0, TESTNUM, fail; \
func2_ ## testnum:  addi  x4, x4, 1; \
    li  x5, 2; \
    bne x4, x5, func1_ ## testnum; \
